 ...
 * 
 * import egovframework.rte.fdl.property.EgovPropertyService; import
...
/*
 * 
 * @Controller public class EgovSampleController {
 * 
 *//** EgovSampleService */
/*
 * @Resource(name = "sampleService") private EgovSampleService sampleService;
 * 
 *//** EgovPropertyService */
/*
 ...
 *//** Validator */
/*
 * @Resource(name = "beanValidator") protected DefaultBeanValidator
 * beanValidator;
 * 
 *//**
	 * 글 목록을 조회한다. (pageing)
	 ...
	 */
/*
 * @RequestMapping(value = "/egovSampleList.do") public String
 * selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO,
